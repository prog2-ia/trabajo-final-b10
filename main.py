...
def main() -> None:
    ...
    pista2: PistaInterior = PistaInterior("INT-01", 10, baloncesto)
    pista2.estado = "Ocupada"
    pista3: PistaExterior = PistaExterior("EXT-02", 4, tenis)
    pista4: PistaInterior = PistaInterior("INT-02", 10, baloncesto)
    todas_las_pistas: list[Pista] = [pista1, pista2, pista3, pista4]
    ...
    ev_normal: Evento = Evento("EV-002", pista2, admin_user, "12:00", 10, 2)  # Prioridad 2 es una reserva cualquiera
...
# Bucle general, para controlar las diferentes opciones
    while True:
        ...
        if opcion == "1":
            ...
            print("\n--- NUEVA RESERVA ---")
            deporte_deseado: str = input("¿Qué deporte quieres jugar? (Tenis/Baloncesto): ").capitalize() #para poner la primera en mayuscula y las demás en minuscula
